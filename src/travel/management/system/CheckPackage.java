...
//        creating array to send data dynamically
        ...
        String [] package3 = {"BRONZE PACKAGE", "6 Days and 5 Nights", "Return Airfare", "Free Clubbing, Horse Rinding & other Games", "River Rafting", "Hard Drinks Free", "Daily Buffet", "BBQ Dinner", "BOOK NOW", "WINTER SPECIAL", "Rs 32000/-", "package3.jpg"};

//        creating 3 tabs and labels for it
        JTabbedPane tab = new JTabbedPane();
//        now calling method to create new Panels everytime
        JPanel p1 = createPackage(package1);
//        adding panel p1 as a component in tab 1
...
//    creating method that would return JPanel for the three tabs that we would add
